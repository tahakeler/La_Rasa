...
This is the "ok but how do I actually use this thing" doc. The one-pager
(`docs/agent-studio-onepager.md`) explains what this tool is and why we're
using it — this doc is just the steps to get it on your machine and start
typing at it. Should take you like 15 minutes, less if you already have Git.

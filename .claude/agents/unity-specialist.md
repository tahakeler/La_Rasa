...
- Advise on the Unity CLI / `com.unity.pipeline` agent-Editor bridge when a
  task needs live Editor inspection or automation (experimental — see
  `.claude/docs/unity-cli-integration.md`)
